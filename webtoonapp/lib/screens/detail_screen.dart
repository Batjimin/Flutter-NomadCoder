...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Future initPrefs() async {
    prefs = await SharedPreferences.getInstance(); //excess open
    final likedToons = prefs.getStringList('likedToons'); //String Lise 탐색
    if (likedToons != null) {
      //ID보유여부 탐색
  ...
  onHeartTap() async {
    ...
    if (likedToons != null) {
      ...
      await prefs.setStringList('likedToons', likedToons); //리스트 핸드폰에 저장.
      setState(() {
        isLiked = !isLiked;
      });
    }
